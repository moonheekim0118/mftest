...
const App = () => (react_1.default.createElement(react_1.default.Suspense, { fallback: "Loading Remote Button..." },
    react_1.default.createElement("div", null,
        react_1.default.createElement("h2", null, "App B Content"),
        react_1.default.createElement(RemoteButton, null))));
exports["default"] = App;
...
module.exports = new Promise((resolve, reject) => {
	if(typeof app_c !== "undefined") return resolve();
	__webpack_require__.l("http://localhost:5173/remoteEntry.js", (event) => {
		if(typeof app_c !== "undefined") return resolve();
